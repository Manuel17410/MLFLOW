...
# MLflow Setup
mlflow.set_tracking_uri("file:///C:/Users/manue/Desktop/DataScience/MLFLOW-main/mlruns")
...
try:
    mlflow.create_experiment("Laptop_Price_Prediction")
except mlflow.exceptions.MlflowException:
    print("Experiment 'Laptop_Price_Prediction' already exists")
...
for model_name, model_class in models.items():
    for params in param_grid:
        with mlflow.start_run():
            ...
            os.makedirs(os.path.dirname(residual_plot_path), exist_ok=True)
            ...
            os.makedirs(os.path.dirname(error_hist_path), exist_ok=True)
...
model_path = r"C:\Users\manue\Desktop\DataScience\MLFLOW-main\mlruns\307840608671297161\af8efef78dc84853ba54d9cf6e3243d1\artifacts\RandomForestRegressor\model.pkl"
...
if os.path.exists(model_path):
    ...
    try:
        ...
        print("Model loaded successfully from the file.")
        
        # Define the path to save the model as 'best_model.pkl'
        ...
        try:
            with open(pickle_path, 'wb') as f:
                pickle.dump(model, f)
            print(f"Model successfully saved as {pickle_path}")
